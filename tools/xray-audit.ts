...
async function main() {
  ...
  console.log('╔═══════════════════════════════════════════════════════════╗');
  console.log('║   XRAY AUDIT - MedicalCor Architecture Standard          ║');
  console.log('║   State-of-the-Art Repository Analysis                   ║');
  console.log('╚═══════════════════════════════════════════════════════════╝\n');

  console.log(`📂 Repository: ${options.rootPath}`);
  console.log(`🏥 Medical-Grade: ${options.medicalGrade ? 'YES' : 'NO'}`);
  ...
  try {
    ...
    if (criticalIssues > 0) {
      console.log(`⚠️  ${criticalIssues} critical issues require immediate attention\n`);
      process.exit(1);
    } else {
