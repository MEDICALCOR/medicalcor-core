...
// Utility functions moved to ./utils.ts to comply with Next.js server actions requirements
// Import from './utils' for: getBreachTypeLabel, getSeverityColorClass, formatDuration
