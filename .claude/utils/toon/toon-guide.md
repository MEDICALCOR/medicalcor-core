...
Full ABNF is RFC 5234 compliant and available in `.claude/utils/toon/references/abnf-grammar.md`.
...
- **Local Spec:** `.claude/utils/toon/README.md`
- **Examples:** `.claude/utils/toon/examples/`
- **Guides:** `.claude/utils/toon/guides/`
- **References:** `.claude/utils/toon/references/`
