/**
 * PostgreSQL Consent Repository (Infrastructure Layer)
 *
 * Persistent storage for GDPR consent records.
 * This is an ADAPTER implementing the ConsentRepository port from domain.
 *
 * NOTE: This file is excluded from the main build to avoid circular dependencies.
 * Import directly if needed: `import { PostgresConsentRepository } from '@medicalcor/core/repositories/postgres-consent-repository'`
 *
 ...
 * ```
 *
 * @module @medicalcor/core/repositories/postgres-consent-repository
 */
 ...
 * providing concrete PostgreSQL database operations for GDPR consent management.
 */
...
/**
 * Factory function to create a PostgreSQL Consent Repository
 */
export function createPostgresConsentRepository(db: DatabaseClient): PostgresConsentRepository {
