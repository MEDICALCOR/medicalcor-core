...
// Explicit exports to avoid naming conflicts with cases, guidance, and shared-kernel
export {
  // Value Objects
  CapacityScore,
  InvalidCapacityScoreError,
  type CapacityLevel,
  type CapacityStaffingRecommendation,
  type BookingStatus,
  type CapacityScoreDTO,
  type CapacityScoreParseResult,
  // Entities - Staff Shift
  createStaffShift,
  updateShiftBookings,
  updateShiftStatus,
  ...
  // Repositories (renamed to avoid conflicts)
  ...
  type PaginationOptions as CapacityPaginationOptions,
  type PaginatedResult as CapacityPaginatedResult,
  type CreateShiftInput,
  type UpdateShiftInput,
  type RepositoryCreatePlanInput,
  type RecordDemandInput,
  notFoundError as capacityNotFoundError,
  duplicateError as capacityDuplicateError,
  validationError as capacityValidationError,
  constraintViolationError,
  connectionError as capacityConnectionError,
  // Domain Services
  ...
  // Domain Events (renamed to avoid conflicts)
  type CapacityEventType,
  type CapacityDomainEvent,
  type EventMetadata as CapacityEventMetadata,
...
} from './capacity-planning/index.js';
