...
const LANGUAGE_MARKERS: Record<SupportedLanguage, string[]> = {
  ro: [
    ...
    'pe',
    'cu',
    // Medical/Dental terms in Romanian
    'implant',
    'extracție',
    'curățare',
    'albire',
    'aparat',
    'ortodonție',
    // Dental Laboratory terms (Romanian)
    'laborator',
    'protetică',
    'coroană',
    'coroane',
  ...
  en: [
    ...
    'has',
    'can',
    // Medical/Dental terms in English
    'implant',
    'extraction',
    'cleaning',
    'whitening',
    'braces',
    'orthodontics',
    // Dental Laboratory terms (English)
    'laboratory',
    'prosthetic',
    'crown',
    'bridge',
  ...
  de: [
    ...
    'ich',
    'sie',
    // Medical/Dental terms in German
    'implantat',
    'extraktion',
    'reinigung',
    'bleaching',
    'zahnspange',
    'kieferorthopädie',
    // Dental Laboratory terms (German)
    'labor',
    'prothetik',
    'krone',
    'brücke',
